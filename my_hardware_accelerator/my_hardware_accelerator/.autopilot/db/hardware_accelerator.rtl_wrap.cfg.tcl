...
set DataType0 [list "ap_axi" "struct ap_axi" $structMem0 0 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType1 [list "ap_axi" "struct ap_axi" $structMem1 0 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
