...
/*
appr: addr of DMA register
src_addr: addr from which DMA reads data
det_addr:  addr to which DMA writes data
*/
class DirectMemoryAccess {
    ...
    public:
        ...
        void ready() {
            this->addr[S2MM_CONTROL_REGISTER >> 2] |= (1u << 0); //1 value shift left 0
